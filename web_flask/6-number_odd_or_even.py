...
# Define the route for URL /number_odd_or_even/<n>
...
def number_odd_or_even(n):
    ...
    if isinstance(n, int):
        ...
        my_html = '6-number_odd_or_even.html'
        return render_template(my_html, n=n, even_or_odd=even_or_odd)
    else:
        return "invalid input. Insert integer"
